/**
  ...
  ******************************************************************************
  */
#ifndef AI_TCN_CAUSAL_H
#define AI_TCN_CAUSAL_H

#include "tcn_causal_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TCN_CAUSAL_MODEL_NAME          "tcn_causal"
#define AI_TCN_CAUSAL_ORIGIN_MODEL_NAME   "tcn_causal_last_step_cubeai"

/******************************************************************************/
#define AI_TCN_CAUSAL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TCN_CAUSAL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TCN_CAUSAL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TCN_CAUSAL_IN_NUM        (1)

AI_DEPRECATED
#define AI_TCN_CAUSAL_IN \
  ai_tcn_causal_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TCN_CAUSAL_IN_SIZE { \
  AI_TCN_CAUSAL_IN_1_SIZE, \
}
#define AI_TCN_CAUSAL_IN_SIZE_BYTES { \
  AI_TCN_CAUSAL_IN_1_SIZE_BYTES, \
}
#define AI_TCN_CAUSAL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TCN_CAUSAL_IN_1_HEIGHT      (64)
#define AI_TCN_CAUSAL_IN_1_CHANNEL     (6)
#define AI_TCN_CAUSAL_IN_1_SIZE        (384)
#define AI_TCN_CAUSAL_IN_1_SIZE_BYTES  (1536)

/******************************************************************************/
#define AI_TCN_CAUSAL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TCN_CAUSAL_OUT \
  ai_tcn_causal_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TCN_CAUSAL_OUT_SIZE { \
  AI_TCN_CAUSAL_OUT_1_SIZE, \
}
#define AI_TCN_CAUSAL_OUT_SIZE_BYTES { \
  AI_TCN_CAUSAL_OUT_1_SIZE_BYTES, \
}
#define AI_TCN_CAUSAL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TCN_CAUSAL_OUT_1_HEIGHT      (1)
#define AI_TCN_CAUSAL_OUT_1_CHANNEL     (6)
#define AI_TCN_CAUSAL_OUT_1_SIZE        (6)
#define AI_TCN_CAUSAL_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_TCN_CAUSAL_N_NODES (39)
 ...
 * @ref ai_tcn_causal_create. Both the activations memory buffer 
 ...
 * using @ref ai_tcn_causal_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tcn_causal_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tcn_causal_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TCN_CAUSAL_*
 * defines into file @ref tcn_causal.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tcn_causal_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TCN_CAUSAL_H */
